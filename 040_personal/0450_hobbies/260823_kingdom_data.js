...
const KINGDOM = {
  ...
  },
  {
    ...
    detail:[
      ...
      {h:"人物像", body:"趙・青歌の軍を率いる将軍。司馬尚の下で動く一角で、宜安の戦線に投入される。"}
    ,
    ...
    battles:["b_gian"],
    rel:[{to:"gakurai",label:"討ち取る"},{to:"zenou",label:"相打ち"},{to:"shin",label:"交戦"},{to:"garo",label:"交戦"},{to:"shibashou",label:"配下"},{to:"zenou",label:"相打ち"},{to:"gakurai",label:"討つ"},{to:"rakushou",label:"同僚"},{to:"shibashou",label:"配下"}]
  },
...
,
  ...
  },
  {
    ...
    detail:[{h:"役割", body:"太鼓の音で隊の士気と進退を制御する、飛信隊独特のポジション。"},
      {h:"最期", body:"朱海平原で戦死。飛信隊の戦鼓を叩き続けた男で、その音が止まったことが隊にとって大きな喪失になった。"},
  ...
  },
  {
    ...
    detail:[{h:"役割", body:"秦の法制度を握る実務家。合理性のためなら手段を選ばない。"},
      {h:"人物像", body:"私語を好まず、話す内容はほぼ国事のみ。呂不韋派を脅かす相手には暗殺も辞さない冷徹さを持つ。"},
  ...
  },
  {
    ...
    detail:[{h:"役割", body:"諸国との折衝を一手に握る。飄々とした態度の裏で国益を計算し尽くす。"},
      ...
      {h:"最期", body:"咸陽で病没。戦場ではなく寿命による退場で、旧世代の文官が静かに舞台を降りる。"},
  ...
  },
  {
    ...
    detail:[{h:"役割", body:"戦争ではなく生産基盤で国を強くする担当。地味だが秦の国力の源。"},
      {h:"位置づけ", body:"戦場に出ないため作中の露出は少ないが、国力＝兵力という構図を成立させている人物。呂不韋が商人らしく実利を重んじたことの象徴でもある。"},
  ...
  },
  {
    ...
    detail:[{h:"人物", body:"見た目通りの猛将タイプだが、騰の指揮下で規律よく働く。"},
      ...
      {h:"人物像", body:"王騎軍第一軍長からのちに騰傘下将軍。軍内最強にして随一の激情家で、事あるごとに激高する。"},
  ...
  },
  {
    ...
    detail:[{h:"戦い", body:"王都奪還戦で山の民と激突する手練れ。"},
      {h:"人物像", body:"残忍で傲慢。剣の速さと重さを極めた自分が世界最強だと信じていた。服を汚した相手を斬るような男だと部下に評されている。"},
      {h:"最期", body:"咸陽の王宮で討たれる。"},
  ...
  },
  {
    ...
    battles:["b_outo"],
    rel:[{to:"sei", label:"標的"},{to:"shin", label:"交戦"},{to:"ryofui",label:"依頼を受ける"},{to:"sei",label:"狙う"}]
  },
  {
    ...
    detail:[{h:"立場", body:"王弟を旗印に権力を握ろうとした重臣。"},
      {h:"最期", body:"咸陽で討たれる。王弟を担いで権力を握ろうとした企ては、政の帰還とともに崩れた。"},
  ...
  /* ───────────── 蚩尤 ───────────── */
  {
    ...
    detail:[{h:"意味", body:"羌瘣が復讐に取り憑かれる理由そのもの。二人で里を出る約束が果たされなかった。"},
      ...
      {h:"人物像", body:"羌瘣と姉妹同然に生きてきた羌族の女性。羌蚩尤候補の中でも群を抜いた強さを持っていた。得物は「白鳳」という名の剣。"},
  ...
  },
  {
    ...
    detail:[{h:"役割", body:"四天王の中で唯一の策士型。廉頗の武を最大限に活かす盤面を作る。"},
      {h:"人物像", body:"本能型と力任せの戦い方を心底軽蔑しており、自分の型より優れた戦い方があるとは認めない男だった。"},
      {h:"最期", body:"蕤平原で戦死。"},
  ...
  },
  {
    ...
    detail:[
      ...
      {h:"人物像", body:"真面目で愛国心の強い老将。将軍という役目に揺るぎない誇りを持ち、それを軽んじられると本気で怒った。"}
    ,
  ...
  },
  {
    ...
    detail:[{h:"役割", body:"荒くれ揃いの桓騎軍で、交渉や段取りといった『言葉の仕事』を引き受ける。"},
      {h:"人物像", body:"元野盗の頭でありながら言葉遣いは丁寧で、桓騎軍では唯一まともに交渉ができる男。異名は紳士。"},
  ...
  },
  {
    ...
    detail:[{h:"人物", body:"見た目通りの乱暴者だが、部下と桓騎に対する情は深い。実働部隊の要。"},
      {h:"人物像", body:"桓騎への忠誠が異常なほど厚く、どんな策でも疑わずに従った。強面だが実はかなりの心配性。"},
      {h:"最期", body:"永久（えいきゅう）で処刑される。戦場での討ち死にではなく、捕らえられた末の死という重い退場になった。"},
  ...
  },
  {
    ...
    detail:[{h:"役割", body:"弓隊を率い、桓騎の奇襲に必要な『確実な一射』を担当する。"},
      {h:"人物像", body:"異名は姐さん。痛みや苦しみを楽しむ残忍さを持ち、桓騎には絶対の忠誠を捧げていた。戦場では無言で集中する。"},
      {h:"最期", body:"肥下で戦死。"},
