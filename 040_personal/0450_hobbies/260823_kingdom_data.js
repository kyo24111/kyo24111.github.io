...
const KINGDOM = {
  meta: {
    title: "キングダム リサーチDB",
    range: "アニメ 第1〜4シリーズ（第1〜129話）／原作 1〜40巻",
    note: "第5シリーズ（鄴攻め編）以降はネタバレになるため未収録。話数・巻数は目安です。",
    updated: "2026-08-23"
  },
  ...
  },
  {
    ...
    ep:"第2シリーズ 第39〜50話", vols:"原作 16〜19巻", era:"秦の内政 / 羌瘣の過去",
    lead:"戦場が一度止まり、政治と過去の清算が進む。三人がそれぞれ次の形に組み替わる期間。",
    beats:[
      {ep:"39〜41話", h:"王のいない王権", body:"王騎を失った秦で、相国・呂不韋の権力はさらに厚くなる。昌平君（軍）・李斯（法）・蔡沢（外交）・司馬空（土木）の四柱が実務を握り、王はまだ飾りに近い。政は親政に向けた足場を、政治の側から作り始める。"},
      {ep:"41〜42話", h:"政と太后", body:"趙での人質時代に自分を庇わなかった母・太后との断絶が表に出る。政の抱えているものが、単なる理想論ではなく個人史に根を持つことが示される。"},
      {ep:"42〜44話", h:"河了貂の選択", body:"戦場で『自分に何ができるか』を突きつけられた河了貂は、武ではなく軍師の道を選び、昌平君の兵法学校へ入る。突撃一辺倒だった飛信隊に、初めて戦術的な意思決定が持ち込まれる準備が始まる。"},
      {ep:"44〜46話", h:"羌瘣の離隊", body:"羌瘣は仇を討つために飛信隊を離れる。巫舞という秘技が寿命を削る代償の上に成り立っていることも明かされ、彼女が何を捨てて戦っていたのかが見えてくる。"},
      {ep:"46〜48話", h:"蚩尤の里", body:"数十年に一度、一族の精鋭が殺し合って『蚩尤』の座を継ぐ儀式。姉のように慕った羌象と交わした、二人で里を出るという約束。羌瘣の芯にあるものが回想として描かれる。"},
      {ep:"48〜49話", h:"幽連との決着", body:"羌象を手にかけた幽連との死闘。復讐が終わったあと、羌瘣に残るのは目的のない自由と、帰る場所としての飛信隊だった。"},
      {ep:"49〜50話", h:"次の階段", body:"信は三百人将を経て千人将へ。渕のような実務型を加えて隊の規模が増し、『個人の武で勝つ』段階から少しずつ離れていく。"},
  ...
  },
  {
    ...
    ep:"第2シリーズ 第51〜77話", vols:"原作 20〜25巻", era:"対魏",
    lead:"師を失った信が、初めて『千人を率いる将』として結果を問われる戦い。同世代が同じ戦場に並ぶ。",
    beats:[
      {ep:"51〜53話", h:"呂不韋の戦争", body:"秦は老将・蒙驁を総大将に、魏の要衝・山陽へ侵攻する。動かしているのは呂不韋であり、これは軍事の話であると同時に政治の話でもある。蒙武・騰という主力が加わり、大軍が国境を越える。"},
      {ep:"53〜56話", h:"三人の千人将", body:"信の飛信隊、王賁の玉鳳隊、蒙恬の楽華隊。寄せ集めの突撃力、名門の規律、天才肌の柔軟さ。同世代の三人が同じ戦場に置かれ、指揮スタイルの差が正面から比較される。王賁は下僕上がりの信を露骨に見下す。"},
      {ep:"56〜59話", h:"廉頗という壁", body:"守るのは、かつて趙三大天に数えられ、王の代替わりで国を出た老将・廉頗。輪虎・玄峰・介子坊・姜燕の四天王を従え、秦の旧世代の将たちさえ名を聞いて表情を変える『別格』が立ちはだかる。"},
      {ep:"59〜63話", h:"首狩り・輪虎", body:"戦線を無視して秦の将だけを狩り続ける輪虎。前線が崩れるのではなく、頭から順に落とされていく恐怖が秦軍に広がる。飛信隊は組織的に対抗する術を持たないまま、この相手を追うことになる。"},
      {ep:"63〜66話", h:"信 対 輪虎", body:"単騎で追いついた信が、格上の将と真正面から一騎打ちに入る。王騎から受け継いだ矛で仕留めたこの一戦が、信の評価を『武功を重ねる千人将』から一段上へ押し上げる。"},
      {ep:"66〜70話", h:"四天王の持ち場", body:"重装で正面を圧殺する介子坊、戦線を保つ姜燕、盤面を組み立てる軍師格の玄峰。四天王それぞれの役割が崩れていく過程で、廉頗軍という一つの生き物が解体されていく。"},
      {ep:"70〜75話", h:"蒙武 対 廉頗", body:"武だけを信じてきた蒙武と、老いても別格の廉頗が真正面からぶつかる。軍略を軽んじてきた男が、格上との力比べに競り勝つ。蒙武にとっても一つの分岐点になる勝負。"},
      {ep:"75〜77話", h:"山陽陥落", body:"廉頗は戦場を去り、山陽は秦の手に落ちる。信は三千人将へ。同世代三人はそれぞれ実績を持ち帰り、次の戦場では上の位を争う関係になる。"},
  ...
  },
  {
    ...
    ep:"第3シリーズ 第78〜83話", vols:"原作 24〜26巻", era:"秦の内政 / 政の過去",
    lead:"戦場を離れ、王と相国が言葉だけで殴り合う。政という人間の芯が明かされる章。",
    beats:[
      {ep:"78〜79話", h:"正面からの論戦", body:"山陽を落として勢いに乗る秦で、政と呂不韋がついに面と向かって国のあり方を論じる。金と力で回すのか、それとも別の原理か。武ではなく言葉で決する、この作品では珍しい種類の対決。"},
      {ep:"79〜80話", h:"趙にいた少年", body:"政は自らの過去を語り始める。人質として趙で生まれ、石を投げられ、人として扱われなかった日々。心を閉ざした少年が、なぜ『戦のない中華』を掲げるに至ったのか。"},
      {ep:"80〜81話", h:"紫夏", body:"その少年を引き取ったのが、趙の女商人・紫夏だった。仕事として引き受けたはずの子どもを、一人の人間として扱った。政が『光』と呼ぶものの原点がここにある。"},
      {ep:"81〜82話", h:"逃避行", body:"追手をかわしながら国境を目指す逃避行。紫夏は最後に自らの命と引き換えに政を秦へ送り届ける。理想が誰かの犠牲の上に立っているという構図が、政の言葉に重さを与える。"},
      {ep:"82話", h:"呂不韋の答え", body:"呂不韋は理想を頭ごなしに否定しない。そのうえで『国は金で回る』と返す。どちらも自分の論に一分の隙もないまま、決着は先送りされる。"},
      {ep:"83話", h:"嵐の前", body:"膨張を続ける秦に対し、中華全土で包囲の動きが始まっていた。次の章でそれが形になる。"}
    ],
  ...
  },
  {
    ...
    ep:"第3シリーズ 第84〜103話", vols:"原作 26〜33巻", era:"対 楚・趙・魏・韓・燕",
    lead:"中華が束になって秦を潰しに来る。国が滅ぶ寸前まで追い込まれ、王の言葉がそれを押し返す。",
    beats:[
      {ep:"84〜86話", h:"五国が組む", body:"膨張する秦を潰すため、利害の異なる楚・趙・魏・韓・燕が一度だけ手を結ぶ。総大将は楚の宰相・春申君、実質の設計者は趙の李牧。兵力差は絶望的で、秦は函谷関という一点に全てを集めて迎え撃つしかない。"},
      {ep:"86〜88話", h:"函谷関", body:"昌平君が全体を差配し、関の上で各将が持ち場を受け持つ。落ちれば咸陽までの道が開くという条件下で、秦軍は削られながら耐える戦い方を選ぶ。連合側は国ごとに担当を分け、四方から同時に圧をかける。"},
      {ep:"88〜91話", h:"蒙武 対 汗明", body:"『中華最強』を自称する楚の大将軍・汗明と、同種の純粋な武で応じる蒙武。力比べの末に討ち取った蒙武が、武でしか語れない男から一段上がる契機になる。"},
      {ep:"91〜93話", h:"王翦の戦い方", body:"仮面の将・王翦が初めて本格的に描かれる。燕のオルド、楚の臨武君を相手に、正面からの消耗を避けて地形と情報で削る。忠誠より損得で動く不気味さが、秦軍の中でも異質な存在感を出す。"},
      {ep:"93〜95話", h:"張唐と成恢", body:"小国・韓が送り込んだ毒使い・成恢。搦め手で秦の将を削ろうとする相手に対し、老将・張唐は自らの死を対価にして討ち取る。旧世代がまた一人退場する。"},
      {ep:"95〜96話", h:"呉鳳明の井闌車", body:"蛇甘平原で討たれた呉慶の子・呉鳳明。武ではなく設計で戦う技術者型の将が、巨大な井闌車で『落ちないはずの城壁』を初めて越えさせる。"},
      {ep:"96〜98話", h:"麃公の火", body:"関に籠ることを拒んで平地に出た麃公が、王騎を討った龐煖と一騎打ちに臨む。理屈ではなく『火』で戦い続けた将が、その火を燃やし尽くして討たれる。"},
      {ep:"98〜99話", h:"李牧の本手", body:"函谷関に全軍が釘付けになっている隙に、李牧は軍を割いて山を越え、王都・咸陽の喉元にある蕞へ迫る。あの総力戦そのものが、彼の盤面の一部だった。"},
      {ep:"99〜101話", h:"蕞 — 王が前に出る", body:"守る兵はほとんどいない。嬴政は自ら蕞へ入り、兵ではない住民に向かって語りかける。命令ではなく理由を示すことで、街ごと戦う集団に変える。政という王の資質が、そのまま国の存亡を決める場面。"},
      {ep:"101〜102話", h:"四人の城壁", body:"信の飛信隊、復讐を終えて戻った羌瘣、軍師となった河了貂、そして政。始まりの四人が同じ城壁に並ぶ。龐煖も現れ、信は再びその前に立つ。壁や昌文君も含め、序盤からの顔ぶれが総登場する。"},
      {ep:"102〜103話", h:"決着", body:"数日の総攻撃に耐え切り、援軍の到着を前に李牧は撤退を選ぶ。楊端和も駆けつけ、連合は崩れ、秦は滅亡の淵から生還した。"},
  ...
  },
  {
    ...
    ep:"第4シリーズ 第104〜129話", vols:"原作 34〜40巻", era:"対趙 / 桓騎の下で",
    lead:"世代が入れ替わり、信は初めて『勝ち方』そのものを問われる。桓騎という異物が突きつける問い。",
    beats:[
      {ep:"104〜105話", h:"戦後の秦", body:"合従軍撃退の功で、王翦・楊端和・桓騎が将軍位に就く。六大将軍のような絶対的な制度ではないが、旧世代の後を継ぐ顔ぶれがここで固まる。飛信隊も三千人将の隊として次の戦場を待つ。"},
      {ep:"105〜106話", h:"蒙驁の死", body:"山陽を落とした老将・蒙驁が、老いに勝てず陣中で世を去る。蒙武・蒙恬という三代が並んだ家の、いちばん上が抜ける。旧世代の退場が続く。"},
      {ep:"106〜108話", h:"屯留の反乱と成蟜", body:"疲弊した秦の隙を突く形で屯留に反乱が起きる。鎮圧に向かったのは、かつて政の王座を狙った王弟・成蟜だった。血統に固執していた男が最後に秦の王族としての務めを選び、命を落とす。政にとって重い回収になる。"},
      {ep:"108〜110話", h:"桓騎の下へ", body:"飛信隊は、野盗上がりの将軍・桓騎の指揮下に組み込まれて黒羊丘へ向かう。飄々として底が読めず、味方でさえ次の判断を先読みできない上官。信が初めて『尊敬できない相手の指揮』を受ける。"},
      {ep:"110〜112話", h:"桓騎軍という異物", body:"摩論・雷土・黒桜・ゼノウ。癖の強い顔ぶれが並ぶ、秦軍の中でも異形の軍団。正攻法をほとんど採らず、騙し・急襲・恐怖で敵を崩す。軍としての強さは本物だという事実が、話をややこしくする。"},
      {ep:"112〜116話", h:"沈黙の狩人・慶舎", body:"趙側で待つのは李牧の腹心・慶舎。自ら網を張り、踏み込んだ瞬間に閉じる罠の名手。動きを読ませないまま将を仕留めてきた相手に、飛信隊は真正面から読み合いの土俵へ引きずり込まれる。"},
      {ep:"116〜119話", h:"河了貂の試練", body:"力押しが通じない盤面で、軍師・河了貂の判断がそのまま隊の生死になる。兵法学校で学んだものを実戦で使い切る章であり、飛信隊が『信の隊』から『信と貂の隊』へ変わっていく過程。"},
      {ep:"119〜122話", h:"勝つための非道", body:"桓騎は黒羊の住民を巻き込む手を平然と選び、実際にそれで勝ちを引き寄せる。信は勝利そのものではなく『どう勝つか』を突きつけられ、上官と正面から衝突する。王騎が示した大将軍像との落差が効いてくる。"},
      {ep:"122〜124話", h:"紀彗", body:"黒羊の民に慕われる趙将・紀彗。戦果よりも領民を守ることを優先する将の存在が、桓騎のやり方の意味をもう一段重くする。同じ戦場に、正反対の『正しさ』が二つ立つ。"},
      {ep:"124〜127話", h:"信 対 慶舎", body:"罠を張る側と踏み込む側の読み合いの果てに、信が慶舎を討ち取る。李牧にとって痛恨の損失であり、信にとっては初めて『知略の将』を正面から食った戦い。"},
      {ep:"127〜129話", h:"決着", body:"秦は黒羊丘を奪い、信は五千人将へ。桓騎軍から那貴が飛信隊に加わり、突撃一辺倒だった隊に『裏を取る』選択肢が増える。得たものと、後味の悪さが同時に残る。"},
