...
const KINGDOM = {
  meta: {
    title: "キングダム リサーチDB",
    range: "単行本1巻 〜 黒羊丘の戦い決着まで",
    note: "鄴攻め（41巻〜）以降はネタバレになるため未収録。巻数は目安です。",
    updated: "2026-08-23"
  },
  ...
  arcs: [
  {
    id:"a1", no:"I", name:"下僕と王 — 王都奪還編", vols:"1〜5巻", era:"秦王政 元年ごろ",
    lead:"下僕の少年が王と出会い、奪われた王座を取り戻すまで。すべての始まり。",
    beats:[
      {h:"出会いと喪失", body:"城戸村の下僕・信と漂は、剣の稽古だけを支えに『天下の大将軍』を夢見ていた。漂が王の影武者として召し上げられ、王宮の政変に巻き込まれて瀕死で村へ帰り着く。漂が最後に残した地図が、信を嬴政のもとへ導く。"},
      {h:"逃亡", body:"弟・成蟜と竭氏らの挙兵で王都を追われた政は、信と、鳥使いの一族の生き残り・河了貂を連れて逃げる。刺客集団・朱凶に追われながら、政は自分の理想を語り始める。"},
      {h:"山界との同盟", body:"少数の兵しか持たない政が選んだ賭けは、山の民との再同盟だった。単身で山界に乗り込み、五百年前の盟約を持ち出して楊端和を説き伏せる。これが戦力の全てを覆す。"},
      {h:"咸陽奪還", body:"山の民とともに王宮へ突入。ランカイや左慈といった障害を越え、成蟜と対峙する。血統を絶対とする成蟜に、政は別の物差しを突きつけた。信は武功によって下僕から士官へ。"},
      {h:"この束のテーマ", body:"血筋か、それを超えるものか。王も、将も、生まれで決まらないという物語の前提がここで置かれる。"}
    ],
    keys:["shin","hyou","sei","tenn","seikyou","youtanwa","shoubunkun","heki","rankai"],
    battles:["b_outo"]
  },
  {
    id:"a2", no:"II", name:"初陣 — 蛇甘平原の戦い", vols:"5〜7巻", era:"対魏",
    lead:"信が初めて『戦争』を知る戦い。個人の剣と、軍という仕組みの落差。",
    beats:[
      {h:"歩兵として", body:"魏の侵攻に対し、秦は麃公を主将に迎え撃つ。士官したばかりの信は歩兵の一兵卒として、澤圭の伍に組み込まれる。尾平・尾到ら、後の飛信隊の顔ぶれが揃い始める。"},
      {h:"縛虎申の丘", body:"鬼百人将・縛虎申の下で丘の死守を命じられる。命令と生存が真正面から衝突し、縛虎申は退かずに戦死。信は『武功を挙げる』ことの意味と、軍の理不尽さを同時に叩き込まれる。"},
      {h:"羌瘣の合流", body:"戦場に現れた謎の剣士・羌瘣。蚩尤族の暗殺者であり、別の目的で秦軍に潜り込んでいた。この出会いが飛信隊の核をもう一つ増やす。"},
      {h:"呉慶と麃公", body:"魏の総大将・呉慶は『戦を無くすために戦う』男だった。政の理想と鏡合わせの思想を掲げた彼を、本能型の麃公が一騎打ちで討ち取る。"},
      {h:"結果", body:"秦の勝利。信はこの戦の武功で百人将へ引き上げられる。"}
    ],
    keys:["shin","kyoukai","hyoukou","bakukoshin","gokei","kan'ou","takuke","obei","obito"],
    battles:["b_dakan"]
  },
  {
    id:"a3", no:"III", name:"王騎の戦 — 馬陽の戦い", vols:"8〜16巻", era:"対趙",
    lead:"巨星の復帰と退場。飛信隊が生まれ、信の目標が『大将軍』として具体化する。",
    beats:[
      {h:"王騎、再び戦場へ", body:"趙が馬陽に侵攻。六大将軍最後の生き残り・王騎が、政の器を見定めたうえで前線に復帰する。蒙武・麃公も加わる豪華な布陣。"},
      {h:"飛信隊誕生", body:"信は百人隊を預かり、王騎から『飛信隊』の名を授かる。長平の生き残りである万極を討ち、寄せ集めの隊が形になっていく。一方で尾到が、信を生かすために命を使い切る。"},
      {h:"摎という過去", body:"王騎が馬陽に執着する理由が明かされる。六大将軍唯一の女将軍・摎と交わした『城を百獲ったら嫁にする』という約束、その百個目がこの地だった。"},
      {h:"趙荘の罠と龐煖", body:"趙軍主将・趙荘は、武神・龐煖という札を伏せて王騎を戦場の奥へ誘い込んでいた。秦は趙荘を破って戦術的には勝つが、王騎は龐煖の一撃で致命傷を負う。"},
      {h:"矛の継承", body:"死に際、王騎は信に自らの矛を託し、『天下の大将軍』への道筋を残した。政は最大の後ろ盾を失う。"},
      {h:"この束のテーマ", body:"物語の第一の区切り。信は武功を重ねる少年から、将としての視野を問われる立場へ移る。"}
    ],
    keys:["ouki","shin","tou","kyou","houken","chousou","bankyoku","fuuki","moubu","hyoukou","obito","tenn"],
    battles:["b_bayou"]
  },
  {
    id:"a4", no:"IV", name:"内なる戦 — 呂不韋と蚩尤", vols:"16〜19巻", era:"秦の内政 / 羌瘣の過去",
    lead:"戦場が一度止まり、政治と過去の清算が進む。三人がそれぞれ次の形に組み替わる期間。",
    beats:[
      {h:"王のいない王権", body:"王騎を失った秦で、相国・呂不韋の権力はさらに厚くなる。昌平君（軍）・李斯（法）・蔡沢（外交）・司馬空（土木）の四柱が国を回し、政は親政に向けた足場を作り始める。母・太后との断絶も表に出る。"},
      {h:"河了貂の選択", body:"戦場で『自分にできること』を突きつけられた河了貂は、武ではなく軍師の道を選び、昌平君の兵法学校へ入る。突撃一辺倒の飛信隊に、初めて戦術を持ち込む準備が始まる。"},
      {h:"羌瘣の離隊", body:"羌瘣は仇を討つため飛信隊を離れる。蚩尤の継承儀式、姉貴分・羌象との約束、そして幽連。彼女が何を背負って戦っていたのかが明かされる。"},
      {h:"次の階段", body:"信は三百人将を経て千人将へ。隊は渕のような実務型を加えて規模を増し、『個人の武で勝つ』段階を離れていく。"}
    ],
    keys:["ryofui","shouheikun","risi","saitaku","shibakuu","taigo","sei","tenn","kyoukai","kyoushou","yuren","en","shin"],
    battles:[]
  },
  {
    id:"a5", no:"V", name:"世代の戦 — 山陽攻略戦", vols:"20〜25巻", era:"対魏",
    lead:"師を失った信が、初めて『千人を率いる将』として結果を問われる戦い。同世代が同じ戦場に並ぶ。",
    beats:[
      {h:"魏へ、再び", body:"秦は老将・蒙驁を総大将に、蒙武・騰を主力として魏の要衝・山陽へ侵攻する。呂不韋の後押しで動く大軍であり、政治と軍事が地続きの戦い。"},
      {h:"同世代が揃う", body:"信（飛信隊）・王賁（玉鳳隊）・蒙恬（楽華隊）という三人の千人将が同じ戦場に立つ。寄せ集めの突撃力、名門の規律、天才肌の柔軟さ — 指揮スタイルの差が正面から比較される。"},
      {h:"廉頗という壁", body:"守るのは、かつて趙三大天に数えられ、王の代替わりで国を出た老将・廉頗。輪虎・玄峰・介子坊・姜燕の四天王を従え、秦の旧世代の将たちさえ名を聞いて表情を変える『別格』が立ちはだかる。"},
      {h:"首狩り・輪虎", body:"戦線を無視して秦の将だけを狩り続けた輪虎に、信が単騎で追いつき討ち取る。信が初めて格上の将を仕留めた戦い。"},
      {h:"蒙武と廉頗", body:"四天王を失った廉頗と、武だけを信じてきた蒙武が真正面からぶつかる。競り勝った蒙武が決着をつけ、山陽は秦の手に落ちた。"},
      {h:"この束のテーマ", body:"個人の武で勝つ段階の終わり。信は三千人将となり、隊をどう動かすかを問われる位置へ移る。"}
    ],
    keys:["mougou","moubu","tou","shin","ouhon","mouten","renpa","rinko","genpou","kaishibou","kyouen","rokuomi"],
    battles:["b_sanyou"]
  },
  {
    id:"a6", no:"VI", name:"王とは何か — 呂不韋との対決", vols:"25〜26巻", era:"秦の内政 / 政の過去",
    lead:"戦場を離れ、王と相国が言葉だけで殴り合う。政という人間の芯が明かされる短い章。",
    beats:[
      {h:"正面からの論戦", body:"山陽を落として勢いに乗る秦で、政と呂不韋がついに面と向かって国のあり方を論じる。金と力で回すのか、それとも別の原理か。武ではなく言葉で決する対決。"},
      {h:"紫夏の記憶", body:"政は趙での少年時代を語る。人質として虐げられていた自分を引き取り、最後は命と引き換えに秦へ送り届けた商人・紫夏。政が『光』と呼ぶものの原点がここにある。"},
      {h:"呂不韋の答え", body:"呂不韋は理想を頭ごなしに否定しない。そのうえで『国は金で回る』と返す。決着はつかず、勝負は後日へ持ち越される。"},
      {h:"嵐の前", body:"膨張を続ける秦に対し、中華全土で包囲の動きが始まっていた。次の章はそれが形になる。"}
    ],
    keys:["sei","ryofui","shika","shoubunkun","shouheikun"],
    battles:[]
  },
  {
    id:"a7", no:"VII", name:"五国、来たる — 合従軍編", vols:"26〜33巻", era:"対 楚・趙・魏・韓・燕",
    lead:"中華が束になって秦を潰しに来る。国が滅ぶ寸前まで追い込まれ、王の言葉がそれを押し返す。",
    beats:[
      {h:"五国が組む", body:"膨張する秦を潰すため、利害の異なる楚・趙・魏・韓・燕が一度だけ手を結ぶ。総大将は楚の宰相・春申君、実質の設計者は趙の李牧。兵力差は絶望的で、秦は函谷関という一点に全てを集めて迎え撃つしかない。"},
      {h:"函谷関の攻防", body:"昌平君が全体を差配し、関の上で各将が持ち場を受け持つ。蒙武は『中華最強』を名乗る汗明と力比べの末に討ち取り、王翦は燕のオルド・楚の臨武君を計算ずくで削り、張唐は毒を使う韓の成恢と刺し違える。魏の呉鳳明は巨大な井闌車で、落ちないはずの城壁を越えさせた。"},
      {h:"麃公の火", body:"関に籠らず平地に出た麃公が、王騎を討った龐煖と一騎打ちに臨む。『火』を燃やし尽くして討たれ、秦はまた一人、旧世代の将を失った。"},
      {h:"李牧の本手", body:"函谷関に全軍が釘付けになっている隙に、李牧は軍を割いて山を越え、王都・咸陽の喉元にある蕞へ迫る。関の攻防そのものが、彼の盤面の一部だった。"},
      {h:"蕞 — 王が前に出る", body:"守る兵はほとんどいない。嬴政は自ら蕞へ入り、兵ではない住民に向かって語りかけ、街ごと戦う集団に変える。信の飛信隊、復讐を終えて戻った羌瘣、軍師となった河了貂、壁や昌文君が同じ城壁に並び、龐煖も再び信の前に現れる。"},
      {h:"決着", body:"数日の総攻撃に耐え切り、援軍の到着を前に李牧は撤退を選ぶ。連合は崩れ、秦は滅亡の淵から生還した。"},
      {h:"この束のテーマ", body:"理念は言葉だけでは終わらない、という証明。始まりの四人が同じ戦場に立ち、政が掲げてきたものが実際に国を救う。"}
    ],
    keys:["sei","shin","kyoukai","tenn","shouheikun","moubu","tou","ousen","choutou","hyoukou","heki","youtanwa","riboku","houken","kaine","shunshinkun","kanmei","rinbukun","seikai","orudo","gohoumei"],
    battles:["b_kankoku","b_sai"]
  },
  {
    id:"a8", no:"VIII", name:"どう勝つか — 黒羊丘の戦い", vols:"34〜40巻", era:"対趙 / 桓騎の下で",
    lead:"世代が入れ替わり、信は初めて『勝ち方』そのものを問われる。桓騎という異物が突きつける問い。",
    beats:[
      {h:"戦後の秦", body:"合従軍を退けた功で、王翦・楊端和・桓騎が将軍位に就く。一方で老将・蒙驁が世を去り、屯留の反乱では成蟜が鎮圧に向かって命を落とす。かつて王座を争った弟が、最後は秦の王族としての務めを選んだ。旧世代と因縁が同時に退場していく期間。"},
      {h:"桓騎の下へ", body:"信の飛信隊は、野盗上がりの将軍・桓騎の指揮下に組み込まれて黒羊丘へ向かう。摩論・雷土・黒桜・ゼノウという癖の強い顔ぶれが並ぶ、秦軍の中でも異形の軍団。"},
      {h:"沈黙の狩人", body:"趙側で待つのは李牧の腹心・慶舎。自ら網を張り、踏み込んだ瞬間に閉じる罠の名手で、飛信隊は真正面から読み合いの土俵に引きずり込まれる。軍師・河了貂の力量がここで試される。"},
      {h:"勝つための非道", body:"桓騎は住民を巻き込む手を平然と選び、実際にそれで勝ちを引き寄せる。信は『勝てばいいのか』という問いを上官から突きつけられ、正面から対立する。黒羊の民を守ろうとする趙将・紀彗の姿が、その問いをさらに重くする。"},
      {h:"決着", body:"信が慶舎を討ち取り、秦は黒羊丘を奪う。信は五千人将へ。桓騎軍から那貴が飛信隊に加わり、隊は突撃一辺倒から一歩抜ける。"},
      {h:"この束のテーマ", body:"強さの次は、正しさ。王騎が示した『大将軍』像と、桓騎が体現する『勝てば官軍』のあいだで、信が自分の線をどこに引くかという章。"}
    ],
    keys:["shin","kanki","tenn","kyoukai","naki","maron","raido","kokuou","zenou","keisha","kisui","riboku","mougou","seikyou","ousen","youtanwa"],
