...
const KINGDOM = {
  meta: {
    ...
    note: "⚠ ネタバレ制限なし。黒羊丘以降（鄴・宜安/肥下・番吾・韓攻略・全面戦争）の展開と、存命キャラの最期まで含みます。2026-09-03にあらすじタブを精読版へ全面改稿（全21章・334の出来事＋各章の要点と復習チェック115問／章の索引つき）。巻数・話数は目安です。",
    updated: "2026-09-03"
  },
...
,
  ...
  arcs: [
  {
    ...
    beats:[
      {ep:"1話", h:"城戸村の二人", body:"中華最西の国・秦の片田舎、城戸村。戦災孤児で下僕の信と漂は、日中は使われ、日が落ちれば剣を打ち合う。身分では一生届かない『天下の大将軍』を二人で目指すという約束が、この物語すべての土台になる。"},
      {ep:"1〜2話", h:"漂の仕官", body:"通りかかった秦の大臣・昌文君の目に留まったのは漂だけだった。剣の実力ではなく顔で選ばれたことを、この時点では二人とも知らない。漂は王宮へ上がり、信は村に残される。"},
      {ep:"2話", h:"漂の死", body:"一ヶ月後、漂は深手を負った状態で村へ帰り着く。息を引き取る直前、信に一枚の地図と『天下の大将軍』の夢を託す。何が起きたのかを説明する時間は残っていなかった。"},
      {ep:"3話", h:"瓜二つの少年", body:"地図の先の小屋にいたのは、漂と瓜二つの少年——秦王・嬴政だった。政は異母弟・成蟜と秦左丞相・竭氏の反乱で玉座を追われ、影武者となった漂と昌文君の手で逃げ延びていた。漂は政の代わりに死んだのだと信は知る。"},
      {ep:"3話", h:"最初の一人", body:"漂に致命傷を負わせた刺客が追いつくが、信がこれを討ち取る。友を殺したのは剣を持った個人ではなく『国』の都合だと気づいたところから、信の怒りは政へ、そして王座へ向く。"},
      {ep:"4話", h:"河了貂の手引き", body:"追手の包囲に囲まれた二人を抜け出させたのが、蓑を被った鳥使い・河了貂。梟鳴の一族の生き残りで、金のために動く子どもとして現れる。三人はまだ互いを利用し合う関係にすぎない。"},
      {ep:"4〜5話", h:"昌文君との合流", body:"刺客団・朱凶の追撃をかわしながら、一行は昌文君らと合流する。だが集められた手勢は反乱軍にまるで足りない。数を作る手段は一つしか残っていなかった。"},
      {ep:"5話", h:"山界へ", body:"政が選んだのは、平地の人間を敵とみなす山の民との再同盟だった。かつての裏切りで五百年断絶した相手のもとへ、五百年前の穆公との盟約を根拠に、ほぼ単身で乗り込む。"},
      {ep:"5〜6話", h:"楊端和との会談", body:"山界の王・楊端和と、バジオウ・タジフ・シュンメンら戦士たちが姿を見せる。政は媚びも脅しもせず『王の道』を説き、山の民が平地に出る理由を示す。武で従わせず、理由で味方に変える交渉だった。"},
      {ep:"7話", h:"同盟成立", body:"楊端和は賭けに乗る。戦力の帳尻が一気に覆り、一行は山を越えて秦王都・咸陽へ向かう。政が最初に手に入れた『兵』は、秦人ではなかった。"},
      {ep:"8〜9話", h:"咸陽突入", body:"王宮内へ潜入した一行は城門を破って広場へ突入。政と楊端和らが広場の敵軍を食い止め、その隙に昌文君副官・壁と信たちが本殿へ通じる回廊を進む。"},
      {ep:"9〜10話", h:"回廊の左慈", body:"回廊で待ち構えていたのは刺客・左慈。信は壁の援護を得てこれを討ち取り、本殿へ到達する。将としての戦い方をまだ知らない信は、ひたすら前へ出るしかない。"},
      {ep:"10話", h:"化猿ランカイ", body:"本殿では鎖に繋がれた巨人・ランカイが襲いかかる。力では到底及ばないが、信の一刀がランカイの戦意を折る。竭氏は討たれ、成蟜は逃亡する。"},
      {ep:"10〜11話", h:"王騎、乱入", body:"広場に現れたのは秦六大将軍・王騎。敵将を討ち、政に『あなたは何を目指すのか』と問いを置いて去っていく。物語最大の存在が、まだ味方でも敵でもない位置で顔を出す。"},
      {ep:"11話", h:"成蟜との対決", body:"『王族の血こそすべて』と信じる王弟に対し、政は別の物差しを突きつける。逃亡した成蟜も気絶させられ、反乱軍は降伏。王座は政の手に戻る。"},
      {ep:"11話", h:"それぞれの一段目", body:"信は下僕の身分から解かれ、土地と家を与えられて次の戦を待つ。山の民は約束通り山界へ帰る。二人の少年が、それぞれの立ち位置で最初の一段を上がる。"},
  ...
  },
  {
    ...
    beats:[
      {ep:"16話", h:"徴集", body:"王都奪還から三ヶ月後、秦は魏の要衝・滎陽へ向けて大将軍・麃公を総大将に十五万を動かす。信は一兵卒として徴集され、澤圭の伍に組み込まれる。尾平・尾到・沛浪ら、のちの飛信隊の骨格がここで揃う。"},
      {ep:"16話", h:"戦場の仕組み", body:"斬った首の数で功が決まり、功が階級と褒賞になる。剣の腕だけを信じてきた信が、初めて『軍』という装置の中に置かれる。前線の兵にとって戦は英雄譚ではなく確率の問題だと突きつけられる。"},
      {ep:"17話", h:"羌瘣という異物", body:"同じ伍に配された無名の剣士・羌瘣。人間離れした速度で敵を斬り伏せながら、自分の目的を一切語らない。蚩尤族の暗殺者が別の理由で秦軍に潜り込んでいたことは、まだ誰も知らない。"},
      {ep:"17話", h:"後手に回る秦軍", body:"魏軍総大将・呉慶は先に城を落とし、さらに滎陽から討って出る。両軍は蛇甘平原で激突するが、秦軍は兵数でも地の利でも劣る。信の所属する第四軍も突撃に投じられる。"},
      {ep:"18話", h:"装甲戦車隊", body:"魏の装甲戦車隊が歩兵の隊列を挽き潰していく。個人の武がまるで意味を持たない兵器の前で、秦軍歩兵は甚大な被害を出す。それでも信たちは孤軍奮闘し、麃公の目に留まる。"},
      {ep:"18〜19話", h:"麃公の全騎馬隊", body:"第四軍の粘りを知った麃公は、全騎馬隊を第四軍のもとへ派遣する。理屈ではなく戦場の『火』を嗅いで動く総大将の判断が、盤面をひとつ動かす。"},
      {ep:"19〜20話", h:"縛虎申の丘", body:"千人将・縛虎申の下に組み込まれ、退けば斬るという条件つきで、魏軍副将・宮元が布陣する丘の攻略を命じられる。命令と生存が真正面から衝突する。信が『上官』というものを初めて意識した相手。"},
      {ep:"20話", h:"刺し違え", body:"縛虎申は丘を登り切り、宮元と刺し違えて戦死する。秦軍は丘を奪取する。勝つために自分の死を計算に入れる将がいる、という事実が信に残る。"},
      {ep:"20〜21話", h:"王騎の講義", body:"丘への布陣を急ぐ秦軍の前に、突如王騎が現れる。信は王騎から『武将とは何か』を教わる。首の数を数える段階の先に、戦場全体を動かす立場があると初めて示される。"},
      {ep:"21話", h:"呉慶という鏡", body:"魏の総大将・呉慶は、滅ぼされた故国を背負い『戦を無くすために戦う』と語る男だった。政の理想と鏡合わせの思想が、敵側から先に提示される。"},
      {ep:"21〜22話", h:"麃公 対 呉慶", body:"麃公本軍が呉慶本陣へ突撃。壁隊の援護と信の働きで本陣へ到達し、一騎討ちとなる。呉慶は奮闘するも、理屈ではなく火で動く麃公の力に敗れて討たれる。"},
      {ep:"22話", h:"勝って、取れず", body:"呉慶討死で魏兵は退却し、秦軍は勝利する。だが本来の目的だった滎陽の奪取には至らず、秦軍は帰国する。戦術の勝ちと戦略の達成は別物だという最初の実例。"},
      {ep:"22話", h:"百人将", body:"帰国後の論功行賞で、信は武功により百人将へ昇格。初めて人を預かる立場になる。"},
  ...
  },
  {
    ...
    beats:[
      {ep:"6話", h:"なぜ中華を統一するのか", body:"蛇甘平原から戻った信が、政に『なぜそこまでやるのか』と問う。答えとして語られるのが、秦人が最も憎まれる国・趙での人質時代だった。"},
      {ep:"6話", h:"邯鄲の日々", body:"趙の王都・邯鄲で生まれた政は、秦人の子として石を投げられ、人として扱われずに育つ。母・太后は自分を庇わなかった。心を閉ざした少年に残っていたのは、生きる理由ではなく生き延びる惰性だった。"},
      {ep:"7話", h:"紫夏という商人", body:"その少年を引き取ったのが、趙の女商人・紫夏。秦への引き渡しを仕事として請けたはずが、政を『商品』ではなく一人の人間として扱う。政が後に『光』と呼ぶものの原点。"},
      {ep:"7話", h:"仕事から情へ", body:"政の脱出は交渉ごとではなく、追手を振り切る逃避行として設計されていた。紫夏の一党は荒事も担う商人集団であり、割の合わない仕事から降りる選択肢は最後まで残っていた。"},
      {ep:"8話", h:"追手", body:"秦の王子を国外へ出すことは趙にとって許しがたい。手引きが漏れ、一行は執拗な追撃を受ける。護衛は一人ずつ欠けていき、逃げ道は削られていく。"},
      {ep:"8〜9話", h:"国境の橋", body:"最後に残ったのは、紫夏が自らの命を差し出して政を秦側へ渡すという選択だった。理想が誰かの犠牲の上に立っているという構図が、ここで確定する。"},
      {ep:"9話", h:"光の中身", body:"紫夏が最後に残した言葉——お前は私が生きた証だ——が、政の芯になる。以後の政の演説は、すべてここに根がある。"},
      {ep:"9話", h:"信の受け取り方", body:"信はこの話を聞いて、政の『中華統一』を綺麗な理想ではなく、誰かが死んで託した約束として理解する。漂を託された自分と同じ形をしていることに気づく。"},
  ...
  },
  {
    ...
    beats:[
      {ep:"—", h:"協力者が消える", body:"ある夜を境に、昌文君の協力者が次々と暗殺される。狙いは昌文君一派の切り崩しに見えたが、真の標的は政そのものだった。"},
      {ep:"—", h:"肆氏の一手", body:"事態を昌文君に伝えた肆氏は、政の護衛として信を王宮に送り込む。竭氏の残党だった男が、この時点では利害から政側へ動いている。"},
      {ep:"—", h:"塞がれた脱出路", body:"翌晩、数々の刺客団が王宮に放たれる。信と政は合流して脱出を図るが、何者かに脱出路を塞がれる。王宮という最も安全な場所が、最も逃げ場のない場所に変わる。"},
      {ep:"—", h:"蚩尤の名乗り", body:"そこへ現れたのが蚩尤——羌瘣だった。蛇甘平原で伍を組んだ相手が刺客として立ちはだかり、信と対峙する。彼女が秦軍に潜り込んでいた理由が、ようやく形を持つ。"},
      {ep:"—", h:"一時休戦", body:"さらに別の刺客団が襲撃し、信と羌瘣は一時休戦して共闘する。呼吸を整えて人間離れした速度を得る『巫舞』が、ここで初めて味方側から観測される。"},
      {ep:"—", h:"撃退", body:"昌文君らが到着し、刺客は完全に撃退される。羌瘣は政の首を取らずに去る。彼女の目的が金でも国でもないことだけが分かる。"},
      {ep:"—", h:"黒幕は呂不韋", body:"事件後に発覚した首謀者は、秦右丞相・呂不韋だった。王の暗殺を企てても揺るがない権力が国の中枢にある、という事実が大王陣営に衝撃を与える。"},
      {ep:"—", h:"四柱の登場", body:"対応策を協議する最中、呂不韋陣営が帰還する。呂不韋は昌平君（軍）・蒙武（武）・李斯（法）・蔡沢（外交）の四柱を率いて参内し、力量差を見せつける。政の側は肆氏ら竭氏残党を吸収して数を作るのが精一杯だった。"},
      {ep:"—", h:"河了貂、軍師を選ぶ", body:"戦場で『自分に何ができるか』を突きつけられていた河了貂は、武ではなく軍師の道を選ぶ。昌平君の軍師学校に入学し、蒙毅らと兵法を学び始める。飛信隊に戦術的な意思決定が入る準備がここで始まる。"},
      {ep:"23〜24話", h:"信、王騎に弟子入り", body:"信は王騎のもとへ通い、修行を乞う。剣の腕だけでは隊は動かせず、隊を動かせなければ将にはなれない。百人将になった信が、次の階段の形を知る期間になる。"},
      {ep:"24話", h:"来たる大戦の影", body:"趙が動き出す気配が濃くなる。次の戦は国境の小競り合いではなく、両国の主力がぶつかる規模になる。"},
      {ep:"—", h:"この束のテーマ", body:"敵の顔が確定する章。政の敵は他国ではなく自国の相国であり、信の課題は強さではなく将としての器だと定義される。"}
    ],
    points:[
  ...
  },
  {
    ...
    beats:[
      {ep:"25話", h:"蒙驁の韓侵攻", body:"大将軍・蒙驁を総大将に二十万が韓へ侵攻し、一ヶ月で十一もの城を落とす快進撃を見せる。秦の主力が東へ向いた——その空白が、次の一手を呼び込む。"},
      {ep:"25話", h:"趙の逆襲", body:"隙を突いて趙三大天・龐煖を総大将とする十二万が馬央、続いて馬陽へ侵攻する。国境の小競り合いではなく、王都圏へ手が届く位置への侵攻だった。"},
      {ep:"25〜26話", h:"王騎、現る", body:"秦は王騎を総大将、蒙武を副将に十万を派遣する。六大将軍最後の生き残りで、昭王の死後は軍を退いて隠棲していた男が、若い王の器を自分の目で測るために戻ってくる。"},
      {ep:"26話", h:"昭王の遺言", body:"出陣前、王騎は政に昭王の遺言を伝える。中華統一という言葉が、思想ではなく秦国の遺志として政に接続される場面。"},
      {ep:"26〜27話", h:"飛信隊、結成", body:"従軍した信のもとに、特殊百人部隊『飛信隊』が結成される。寄せ集めの歩兵が名前と旗を持ち、以後『少数で将首を狙う隊』という性格を固めていく。"},
      {ep:"27〜28話", h:"乾原・馮忌の策", body:"両軍は乾原で開戦。趙右軍の将・馮忌の堅実な策により、秦左軍が大損害を出す。堅く削ってくる知将に、力押しの回答は無い。"},
      {ep:"28〜29話", h:"信、馮忌を討つ", body:"王騎の特命を受けた飛信隊が趙右軍の側面へ突撃し、守備隊を突破して馮忌本陣に迫る。秦左軍の将・干央と千人将・壁も反撃に出て本陣一帯が乱戦となり、その隙に信が馮忌を討ち取る。"},
      {ep:"29〜30話", h:"蒙武の三日", body:"中央の蒙武軍は一日目こそいなされるが、二日目・三日目と趙軍へ大損害を与える。武だけで押し切る男が、実際に戦線を動かしている。"},
      {ep:"30話", h:"四日目・総攻撃", body:"趙軍は全軍で蒙武を狙うが、王騎は先んじて全軍総攻撃を掛ける。趙軍は後方の山間部へ退却し、盤面は秦の優勢に見えていた。"},
      {ep:"30〜31話", h:"その夜、武神", body:"夜営地に突如龐煖が現れ、秦兵を屠っていく。続いて趙将・万極の夜襲。飛信隊は龐煖を狙うが届かず敗走し、万極軍の猛追を受ける。"},
      {ep:"31〜32話", h:"尾到", body:"敵中で消耗し切った信を背負い、尾到は味方陣地の目前まで走り抜いて力尽きる。隊員たちの奮闘で飛信隊は難を逃れ、翌朝に再集結する。信が『自分が生きているのは誰かが死んだから』と知る場面。"},
      {ep:"32〜33話", h:"万極という戦争の残骸", body:"長平の生き埋めを生き延びた万極は、秦兵を殺すことだけが生きる理由になっていた。戦争が人に何を残すのかという、この作品の暗い側面が正面から出てくる。"},
      {ep:"33〜34話", h:"摎という過去", body:"王騎が馬陽にこだわる理由が明かされる。六大将軍唯一の女将軍・摎、孤児から拾われて城を落とし続けた歩み、そして『城を百獲ったら嫁にする』という約束。その百個目がこの地で、彼女を討ったのが龐煖だった。"},
      {ep:"34〜35話", h:"五日目・王騎の采配", body:"王騎は自ら敵将（趙荘）を討つ。だが趙本陣へ猛攻を掛けた蒙武が罠に嵌まり、窮地に陥る。趙荘は龐煖という札を伏せたまま、盤面を設計していた。"},
      {ep:"35〜36話", h:"王騎 対 龐煖", body:"蒙武軍を救うべく王騎は趙本軍と対峙し、歩兵を囮に本陣へ突入して龐煖と一騎打ちに入る。摎の仇を追い詰めるところまでは、確かに王騎の勝ちだった。"},
      {ep:"36〜37話", h:"李牧の挟撃", body:"そこへ趙三大天・李牧率いる大軍が秦軍を挟撃する。さらに王騎は背後からの狙撃を受け、その隙に龐煖に胸を貫かれる。戦術ではなく盤面全体で負けていたことが、ここで判明する。"},
      {ep:"37〜38話", h:"王騎の死", body:"騰らの奮闘で包囲を突破した王騎は、信に自らの矛を託し、天下の大将軍への道筋を言葉で残して世を去る。政は最大の後ろ盾を失い、信は背負うものを一つ増やす。"},
      {ep:"38話", h:"戦後", body:"趙軍は撤退し、秦は馬陽を守り切る。論功行賞で信は三百人将へ昇格。王騎軍は副官・騰が引き継ぐ。"},
  ...
  },
  {
    ...
    beats:[
      {ep:"1話", h:"李牧、咸陽へ", body:"呂不韋の画策により、趙宰相・李牧が秦を訪れる。王騎を討った当人を国賓として迎えるという異常事態の裏で、呂不韋は自分の外交実績を作りに動いている。"},
      {ep:"1〜2話", h:"秦趙同盟", body:"李牧の提言により秦趙同盟が締結される。趙にとっては時間稼ぎ、呂不韋にとっては手柄。国と国の合意が、当事者の思惑とは別の理由で成立していく過程が描かれる。"},
      {ep:"2話", h:"宴席の宣戦", body:"宴席で信は李牧に対し、必ず戦場で倒すと豪語する。三百人将が他国の宰相に向けて言うにはあまりに軽い言葉だが、この場面が以後ずっと回収され続ける。"},
      {ep:"2〜3話", h:"若い世代", body:"前線では信・王賁（玉鳳隊）・蒙恬（楽華隊）といった若き将が武功を重ね始める。名門の子・王賁は下僕上がりの信を露骨に見下し、蒙恬は誰とでも噛み合う柔軟さで動く。"},
      {ep:"3〜4話", h:"王のいない王権", body:"王騎を失った秦で、相国・呂不韋の権力はさらに厚くなる。昌平君（軍）・李斯（法）・蔡沢（外交）・司馬空（土木）が実務を握り、王はまだ飾りに近い。"},
      {ep:"4話", h:"白紙の書簡", body:"政陣営のもとに、政の母・太后から白紙の書簡が届く。意味を掴めないまま、政は翌朝みずから太后のもとへ赴く。"},
      {ep:"4〜5話", h:"政と太后", body:"政は打倒呂不韋への協力を頼むが、太后はすでに呂不韋と密通していた。趙での人質時代に自分を庇わなかった母との断絶が、政治の問題として表に出る。"},
      {ep:"5話", h:"向の報せ", body:"密通を知った宮女・向は、大怪我を負いながら政のもとへ辿り着いて事実を伝える。政が攻勢へ転じる決断は、この一人の女性が命を賭けて運んだ情報から始まっている。"},
      {ep:"6〜8話", h:"陣営を作る", body:"呂不韋派と大王派の二極に、軍の頂点である昌平君がどう動くかが加わる。政は自分の陣営を『数』ではなく『理由』で増やしていく。"},
      {ep:"8〜10話", h:"次の階段", body:"信は三百人将の隊を回すのに手一杯で、突撃だけでは足りない現実に直面する。渕のような実務型が加わり、隊としての形が整い始める。"},
      {ep:"10話", h:"次の戦場", body:"呂不韋は自身の権力を固めるため、魏の要衝・山陽の攻略を打ち出す。戦の理由が国防から政治になった最初の大攻勢が、次章で始まる。"},
      {ep:"—", h:"この束のテーマ", body:"戦場ではなく朝廷で盤面が動く章。政の敵は他国ではなく自国の相国であり、味方は血縁ではなく理由で繋がると確認される。"}
    ],
    points:[
      "秦趙同盟は呂不韋の画策＋李牧の提言。互いに時間と手柄が欲しかっただけで、信頼はどこにもない。",
      "信が宴席で李牧に『戦場で倒す』と宣言。以後の全編にわたる因縁の宣言。",
      "太后は呂不韋と密通していた。政と母の断絶が、のちの毐国反乱編の火種になる。",
      "向が大怪我を負って情報を運んだことで、政は攻勢に転じられた。",
  ...
  },
  {
    ...
    beats:[
      {ep:"11〜13話", h:"呂不韋の戦争", body:"魏の要衝・山陽一帯を攻略すべく、大将軍・蒙驁を総大将に二十万強が侵攻する。動かしているのは相国・呂不韋であり、これは軍事の話であると同時に、王を出し抜くための政治の話でもある。"},
      {ep:"13話", h:"二人の副将", body:"蒙驁の副将として王翦と桓騎が姿を見せる。名門出身で底の見えない王翦、野盗上がりで正攻法を採らない桓騎。以後の秦軍を背負う二枚が、ここで初めて盤上に乗る。"},
      {ep:"13〜15話", h:"廉頗という壁", body:"守るのは、かつて趙三大天に数えられ、王の代替わりで趙を出た老将・廉頗。輪虎・玄峰・介子坊・姜燕の四天王を従え、秦の旧世代の将たちさえ名を聞いて表情を変える『別格』が立ちはだかる。"},
      {ep:"15〜17話", h:"首狩り・輪虎", body:"秦軍は城を落としながら行軍するが、四天王・輪虎が秦の千人将を次々に暗殺していく。戦線が崩れるのではなく、頭から順に落とされていく恐怖が軍全体に広がる。"},
      {ep:"17〜18話", h:"三人の臨時千人将", body:"千人将が足りなくなった秦軍は軍を再編成し、蒙恬・王賁・信を臨時千人将に引き上げる。飛信隊の突撃力、玉鳳隊の規律、楽華隊の柔軟さ。同世代三人が同じ戦場で比較される構図が完成する。"},
      {ep:"18〜19話", h:"流伊平野・一日目", body:"両軍は流伊平野で開戦。先鋒同士の激突は一進一退となるが、四天王・玄峰の策略により秦軍は大損害を被る。読み合いで先に殴られる形で戦いが始まる。"},
      {ep:"19〜21話", h:"二日目・両翼", body:"王翦率いる左軍は姜燕らの猛攻で後退。一方、桓騎率いる右軍は介子坊に対し奇策で応じ、魏軍を翻弄する。同じ軍の中に、まるで別種の将が二人いる。"},
      {ep:"21〜22話", h:"四日目・桓騎、玄峰を討つ", body:"桓騎は自ら魏軍へ潜入し、軍師格の玄峰を討ち取る。正面から当たらずに頭を落とすという戦い方が、味方にも不気味さを残す。"},
      {ep:"22〜24話", h:"五日目・二人がかりの輪虎", body:"蒙恬の策により信と王賁が輪虎に襲い掛かるが、輪虎は二人相手に互角以上に戦う。限界を越えた信の一刀が輪虎の左手を負傷させ、ようやく傷を付けるところまで持っていく。"},
      {ep:"24〜25話", h:"五日目・王翦の退却", body:"秦左軍では壁が敵将を追い詰めるも策に嵌まって窮地に陥る。そこへ王翦本軍、さらに廉頗本人が現れる。王翦は戦わずに後方の砦へ退却し、その判断の意味は誰にも読めない。"},
      {ep:"25〜28話", h:"六日目・信 対 輪虎", body:"輪虎率いる魏中央軍の突撃を飛信隊が止め、信と輪虎の一騎討ちに入る。王騎から受け継いだ矛で、信は死闘の末に格上の将を討ち取る。信の評価を一段押し上げた一戦。"},
      {ep:"28〜32話", h:"六日目・廉頗 対 蒙驁", body:"廉頗軍が蒙驁本陣の背後から攻め込み、廉頗は蒙驁の策を破って本陣へ到達、一騎討ちとなる。蒙驁は奮闘するも左腕を失う。老将同士の力量差が容赦なく出る。"},
      {ep:"32〜35話", h:"廉頗、信に向く", body:"輪虎を討った信に、廉頗が矛を向ける。四天王を育てた男にとって輪虎の死は個人的な損失であり、この時点で信を殺せる状況が実際に生まれている。"},
      {ep:"35〜37話", h:"桓騎、魏本陣を落とす", body:"戦場の外側で、桓騎が魏本陣を陥落させる。廉頗は勝敗が決したことを認め、和睦に応じる。前線で誰より強い将が、後方の一手で負けを認めさせられる。"},
      {ep:"37〜38話", h:"山陽、秦の手へ", body:"秦は山陽を獲得する。廉頗は魏を出て楚へ亡命し、四天王の残りもそれに従う。旧世代の最強格が、この戦を境に別の国の話になる。"},
      {ep:"38話", h:"羌瘣の離脱", body:"帰路の途中、羌瘣は姉同然だった羌象の仇を取るため飛信隊を一時離脱する。以後、彼女は合従軍編の最後まで戦場から姿を消す。"},
      {ep:"38〜39話", h:"千人将", body:"論功行賞で信は正式に千人将へ昇格。同世代三人はそれぞれ実績を持ち帰り、次の戦場では上の位を争う関係になる。"},
      {ep:"—", h:"幕間・山陽平定", body:"三ヶ月後、飛信隊は敗戦を重ねて再降格の危機に陥る。そこへ軍師学校を出た河了貂が加入して立て直し、山陽平定に貢献する。山陽は東郡へ改称され、秦の領土として組み込まれる。"},
      {ep:"—", h:"幕間・各国の動き", body:"飛信隊は対楚前線へ送られ、信は楚軍千人将の項翼・白麗と小競り合いを起こす。趙では李牧と龐煖が燕へ侵攻して劇辛を討ち取り、咸陽では嫪毐が太后のもとへ送り込まれて呂不韋陣営が拡大、呂不韋は相国に就任する。"},
      {ep:"—", h:"幕間・政陣営の反撃", body:"政は成蟜一派を解放して呂不韋打倒に協力させ、昌平君と昌文君が丞相に就任する。政陣営がようやく実権の一部を握り、次章の総力戦を戦える体裁が整う。"},
      {ep:"—", h:"この束のテーマ", body:"個人の武で勝つ段階の終わり。信は隊をどう動かすかを問われる位置へ移り、世代交代が実際の階級として形になる。"}
    ],
    points:[
      "秦軍の編成＝総大将 蒙驁／副将 王翦（左軍）・桓騎（右軍）。王翦と桓騎の初登場はこの戦い（19巻）。",
      "廉頗四天王＝輪虎・玄峰・介子坊・姜燕。玄峰は桓騎が討ち、輪虎は信が討った。",
      "廉頗と一騎討ちしたのは蒙驁（左腕を失う）。蒙武はこの戦いには参加していない。",
      "決着をつけたのは前線ではなく、桓騎が魏本陣を落としたこと。廉頗は敗北を認めて和睦した。",
  ...
  },
  {
    ...
    beats:[
      ...
      {ep:"12〜13話", h:"七日目・成恢の毒", body:"韓軍総大将・成恢が仕掛けた毒を秦将・張唐が喰らう。真正面から戦わずに秦の柱を一本ずつ抜いていく、韓なりの戦い方だった。"},
      {ep:"13話", h:"十五日目・総攻撃", body:"合従軍は全軍による総攻撃に出る。蒙武軍は楚軍総大将・汗明軍に斜陣掛けを仕掛けて自らも突撃し、騰軍は媧燐軍の猛攻に対して王賁・蒙恬を抜擢する。若い世代が最前線に投げ込まれる。"},
      {ep:"13〜14話", h:"十五日目・張唐の最後の仕事", body:"函谷関では呉鳳明の猛攻が続くなか、張唐が桓騎と共に韓本陣を奇襲して成恢を討ち取る。そして毒で力尽きる。老将が自分の残り時間を計算に入れて使い切った一手。"},
      {ep:"14〜15話", h:"十五日目・オルドと王翦", body:"燕軍総大将オルドは函谷関の裏を狙うが、王翦軍の急襲を受けて退却する。表の攻防が最大化した瞬間に、裏を塞いでいたのは動かない将だった。"},
      ...
      {ep:"16話", h:"媧燐、あと一歩", body:"媧燐本軍は蒙武を狙いつつ函谷関を陥落寸前まで追い込む。だが王翦の機転によって関は守り切られ、合従軍は開戦前の位置まで退却する。函谷関の攻防はここで終わる。"},
  ...
  },
  {
    ...
    beats:[
      {ep:"25話", h:"蚩尤の里", body:"数十年に一度、一族の精鋭が殺し合って『蚩尤』の座を継ぐ祭。羌瘣と羌象は互いに殺し合わないために、二人で里を出るという約束を交わしていた。"},
      {ep:"25話", h:"羌象の死", body:"祭の最中、羌象は幽連に殺される。羌瘣が刺客として国外に出たのも、飛信隊にいたのも、この一人を殺した相手に届くための時間稼ぎだった。"},
      {ep:"25話", h:"巫舞の代償", body:"呼吸を整えて人間離れした速度を得る巫舞は、寿命を削る代償の上に成り立っている。羌瘣が何を捨てて戦っていたのかが、ここで初めて数字として示される。"},
      {ep:"25〜26話", h:"幽連の居所", body:"羌瘣は単独で幽連のもとへ乗り込む。相手は蚩尤の座を継いだ者であり、力量差は明らかだった。"},
      {ep:"26話", h:"圧倒される", body:"幽連の力に羌瘣は圧倒される。復讐のために積み上げてきたものが、正面からは通じない。"},
      {ep:"26話", h:"辛勝", body:"それでも羌瘣は辛くも勝つ。決め手になったのは技量ではなく、羌象と過ごした時間そのものだった。"},
      {ep:"26話", h:"帰る場所", body:"復讐が終わったあとに残ったのは、目的のない自由と、帰る場所としての飛信隊だった。羌瘣は隊へ復帰する。"},
      {ep:"—", h:"この束のテーマ", body:"羌瘣は『誰かのために戦う』側へ移る。以後の彼女の強さは、私怨ではなく隊の生存に使われる。"}
    ],
    points:[
  ...
  },
  {
    ...
    beats:[
      {ep:"1話", h:"蒙驁の死", body:"始皇七年、大将軍・蒙驁が危篤に陥る。駆けつけた蒙恬と信に英雄への道を示して、山陽を落とした老将は世を去る。旧世代がまた一枚抜ける。"},
      {ep:"1話", h:"世代の交代", body:"向が政の子を出産し、前線では王翦と桓騎が魏の慶都・汲を落とす。各国では李牧や春申君ら要人が合従軍敗戦の責で左遷され、政争が激化していく。"},
      {ep:"1〜2話", h:"一進一退", body:"秦では蕞以降、政陣営が勢力を拡大していた。かつて王座を争った成蟜が政側で奮闘し、呂不韋陣営との権力争いは互角に近づく。"},
      {ep:"2話", h:"趙軍、屯留へ", body:"始皇八年、趙軍二万が秦北東の要衝・屯留へ侵攻する。成蟜軍三万五千は、屯留にいる成蟜夫人・瑠衣を救うべく出陣し、これを撃退する。"},
      {ep:"2〜3話", h:"蒲鶮の裏切り", body:"だが呂不韋の後援を受けた屯留代官・蒲鶮が成蟜を投獄し、成蟜の名を使って反乱を起こす。王族の名前が、そのまま反乱の旗になる。"},
      {ep:"3話", h:"壁の討伐軍", body:"将軍・壁率いる四万の討伐軍が出陣し、屯留軍七万と盟平野で激突する。数で劣る側が正面から当たらざるを得ない盤面になる。"},
      {ep:"3〜4話", h:"趙軍の側面奇襲", body:"屯留軍と内通していた趙軍一万が側面から奇襲を仕掛け、討伐軍は崩されかける。そこへ増員された飛信隊が参戦して趙軍を撃退し、屯留軍も撤退する。"},
      {ep:"4話", h:"井闌車", body:"討伐軍は屯留城を攻撃し、井闌車を投入して城内へ侵入する。成蟜の救出が最優先で急がされる。"},
      {ep:"4〜5話", h:"成蟜の脱獄", body:"成蟜は自力で牢を破って瑠衣を救出し、蒲鶮からの逃亡を図る。だが逃げ切れないと判断すると、瑠衣だけを逃がして蒲鶮と刺し違える。"},
      {ep:"5話", h:"託す", body:"飛信隊を連れて戻った瑠衣に対し、成蟜は政への協力を頼み、信に政を託して落命する。血統こそすべてと言い続けた男が、最後に選んだのは秦の王族としての務めだった。"},
      {ep:"5話", h:"反乱終結", body:"討伐軍が屯留を奪還し、反乱は終結する。政は最大の政敵の一角を削った代わりに、たった一人の弟を失う。"},
  ...
  },
  {
    ...
    beats:[
      {ep:"6話", h:"著雍を取る", body:"魏の要衝・著雍を奪取すべく、王騎軍を継いだ騰が総大将として侵攻する。魏軍の総大将は、合従軍で函谷関を追い詰めた技術屋・呉鳳明。"},
      {ep:"6〜7話", h:"魏火龍七師", body:"魏は増援として、呉慶と同時代に魏の中核を担った魏火龍七師のうち霊凰・凱孟・紫伯を投入する。長く幽閉されていた猛将たちが、国の危機で再び戦場に出される。"},
      {ep:"7話", h:"鉄壁の布陣", body:"呉鳳明の布陣は正面から崩す隙がない。そこで王賁が策を立案する——録嗚未軍・玉鳳隊・飛信隊の三軍が、三日目の正午に同時に魏軍本陣へ突入する。時刻を決め打ちにした賭けだった。"},
      {ep:"7〜8話", h:"一日目・信 対 凱孟", body:"飛信隊の前に立ったのは、大義も理屈もなく『強い奴と斬り合いたい』という動機だけで動く凱孟。信の価値観を逆から照らす相手であり、一騎討ちは決着がつかない。"},
      {ep:"8〜9話", h:"一日目・河了貂の拉致", body:"混戦の中で河了貂が敵に拉致される。軍師を失えば飛信隊の策は止まる。隊にとって最も痛い一点を、敵が正確に突いてくる。"},
      {ep:"9〜10話", h:"二日目・人質交換", body:"飛信隊は捕らえていた凱孟の軍師と貂を人質交換で取り戻し、その後で敵前線を突破する。凱孟が交換に応じるという事実そのものが、この男の性格を語っている。"},
      {ep:"10〜11話", h:"二日目・玉鳳隊の敗北", body:"前日に敵前線を突破していた玉鳳隊は紫伯軍と激突し、紫伯の槍術と策略の前に敗れる。名門の規律で押してきた王賁が、格上に真正面から折られる。"},
      {ep:"11〜12話", h:"三日目・王賁 対 紫伯", body:"三日目、飛信隊が凱孟軍へ突撃し、録嗚未軍も出陣する。王賁は紫伯に一騎討ちを挑み、激闘の末に討ち取る。王賁がこの戦で一段上へ抜ける瞬間。"},
      {ep:"12〜13話", h:"三日目・本陣突入", body:"玉鳳隊と録嗚未軍が魏軍本陣に突入。王賁の立てた三日目正午の策が、遅れながらも成立する。"},
      {ep:"13話", h:"信、霊凰を討つ", body:"信が魏火龍七師の霊凰を討ち取り、魏軍は撤退する。秦は著雍を奪取し、そのまま要塞化を進める。"},
      {ep:"13話", h:"五千人将", body:"論功行賞で信と王賁はともに五千人将へ昇格し、飛信隊は八千人隊に増える。同世代の二人が、初めて同じ位で並ぶ。"},
  ...
  },
  {
    ...
    beats:[
      {ep:"13〜14話", h:"太后の来訪", body:"咸陽に突如太后が現れ、嫪毐を山陽長官の座に強引に据える。政の母が、政の国の要職を政の敵側の人間で埋めていく。"},
      {ep:"14〜16話", h:"毐国の建国", body:"太原に入った嫪毐と太后は『毐国』の建国を宣言する。秦の内側に別の国ができるという異常事態に、さらに楚の侵攻が重なる。"},
      {ep:"16〜17話", h:"手を出せない", body:"膨張を続ける毐国に対し、秦は手をこまねいていた。太后という王の母を敵に回す手続き上の難しさが、そのまま時間の損失になる。"},
      {ep:"17〜18話", h:"加冠の儀", body:"始皇九年、ついに成人した政は旧都・雍で加冠の儀を執り行う。王が名実ともに王になるための儀式が、最も危うい時期に重なる。"},
      {ep:"18〜19話", h:"毐国軍、咸陽へ", body:"毐国軍三万が函谷関をすり抜けて咸陽へ侵攻する。迎え撃つのは飛信隊一千と、蕞の兵一万。かつて政が守った街の住民が、今度は政のために出てくる。"},
      {ep:"19〜20話", h:"昌平君の離反", body:"加冠の儀を終えた雍で、昌平君が呂不韋を離反し、昌文君と共に毐国軍討伐へ向かう。軍の頂点がどちらに付くかという長い保留が、ここで解ける。"},
      {ep:"20〜22話", h:"呂不韋 対 政", body:"呂不韋と政が正面から舌鋒を交わす。呂不韋は『金を操って国を治める』と語り、政は『戦争を無くすために中華を統一する』と宣言する。どちらの論にも隙はなく、決着は咸陽の戦いに委ねられる。"},
      {ep:"22〜23話", h:"咸陽攻防", body:"呂不韋一派の妨害もあり討伐軍は咸陽防衛に苦戦する。街の中での戦闘となり、王都そのものが戦場になる。"},
      {ep:"23〜24話", h:"決着", body:"昌平君率いる軍が敵将を討ち、反乱軍は撤退する。政は呂不韋との争いに完全勝利する。言葉で始まった対決が、最後は兵の数で決まった。"},
      {ep:"24話", h:"毐国の終わり", body:"毐国軍は桓騎軍によって粉砕され、楚軍も退却する。嫪毐は咸陽で処刑され、太后は幽閉される。呂不韋は相国の座を失う。"},
      {ep:"24〜25話", h:"十五年", body:"ようやく秦の実権を掌握した政は、信に自らの大構想を明かす——十五年で中華を統一する。理想が初めて工程になる。"},
      {ep:"—", h:"この束のテーマ", body:"物語の第一部の終わり。以後の敵は国内の権力ではなく、六国そのものになる。"}
    ],
    points:[
  ...
  },
  {
    ...
    beats:[
      {ep:"26話", h:"周辺の地図が動く", body:"楊端和率いる山の民が魏の要衝・衍氏を陥落させる。楚では考烈王が崩御し、春申君も李園に暗殺される。実権を握った李園は媧燐と共に楚の宰相に就任する。"},
      {ep:"1〜2話（第5期）", h:"桓騎の下へ", body:"始皇十年、飛信隊は桓騎軍五万と共に趙の要衝・黒羊丘へ侵攻する。飄々として底が読めず、味方でさえ次の判断を先読みできない上官。信が初めて『尊敬できない相手の指揮』を受ける。"},
      {ep:"2〜3話", h:"五つの丘", body:"黒羊丘は密林地帯で、そこにある五つの丘の奪取が両軍の目標になる。視界が利かない地形で、どこに敵がいるか分からない状態から戦いが始まる。"},
      {ep:"3〜4話", h:"沈黙の狩人・慶舎", body:"趙軍の総大将は李牧の腹心・慶舎。自ら網を張り、踏み込んだ瞬間に閉じる罠の名手。副将は離眼城主・紀彗で、領民に慕われる将という正反対の性格を持つ。"},
      {ep:"4〜5話", h:"一日目・翻弄", body:"秦右軍の飛信隊は紀彗の副官・馬呈と劉冬の奇襲に翻弄される。秦左軍は慶舎とその副官・岳嬰の急襲を受けて敗走。緒戦は趙側の設計通りに進む。"},
      {ep:"5〜6話", h:"一日目・雷土の焼き討ち", body:"一方で桓騎側近・雷土らは趙軍の砦を焼き討ちにする。正攻法をほとんど採らず、騙し・急襲・恐怖で敵を崩す桓騎軍の性格がここで出る。"},
      {ep:"6〜7話", h:"その夜・羌瘣の重傷", body:"羌瘣は劉冬に夜襲を仕掛けるが返り討ちに遭い、瀕死の重傷を負う。飛信隊最強の一枚が、開始二日目で戦線から外れる。"},
      {ep:"7〜9話", h:"二日目・渡河", body:"飛信隊は川辺に布陣した馬呈軍と対峙し、渡河を成功させて前線を押し上げる。力押しではなく段取りで勝った局面であり、河了貂の判断がそのまま隊の生死になる。"},
      {ep:"9〜11話", h:"三日目・何もしない上官", body:"中央丘の麓に迫った飛信隊は桓騎の指示を仰ぐ。だが桓騎は一切何もせずに一日を終える。意図が読めない沈黙が、味方をじりじりと削っていく。"},
      {ep:"11〜14話", h:"四日目・混戦", body:"慶舎自らが飛信隊に猛攻を掛ける。そこへ慶舎を討つべく桓騎軍が乱入し、さらに紀彗自らが慶舎救出に向かったことで戦場は混戦状態になる。桓騎の三日間の沈黙は、この一瞬を作るためのものだった。"},
      {ep:"14〜17話", h:"四日目・信 対 慶舎", body:"脱出した慶舎を飛信隊が捕捉し、信は激戦の末に討ち取る。罠を張る側と踏み込む側の読み合いに、初めて信が勝った戦い。羌瘣も手負いの劉冬を辛くも討つ。"},
      {ep:"17〜19話", h:"紀彗、退かず", body:"だが紀彗は慶舎の副官・金毛を説得して徹底抗戦に出る。総大将を失った軍が崩れないという想定外に、桓騎は軍を中央丘から撤退させる。"},
      {ep:"19〜22話", h:"五日目・虐殺", body:"桓騎軍は集落を焼き討ちにして住民を虐殺する。勝つために非道を平然と選び、実際にそれで勝ちを引き寄せる。王騎が示した大将軍像との落差が、ここで正面から効いてくる。"},
      {ep:"22〜24話", h:"羌瘣の暴発", body:"虐殺を知った羌瘣は冷静さを失い、桓騎本陣に乗り込んで桓騎兵を殺傷する。味方同士の刃傷沙汰という一触即発の事態になり、信は上官と正面から衝突する。"},
      {ep:"24〜25話", h:"脅迫で終わる戦", body:"桓騎は紀彗に対し、離眼での虐殺を予告して脅迫する。領民を守ることを優先する紀彗は撤退を選び、その隙に桓騎は黒羊丘を占領して勝利を収める。"},
      {ep:"25〜26話", h:"武功の取り消し", body:"羌瘣が起こした刃傷沙汰が取沙汰され、信の武功は取り消される。勝ったのに何も残らない。後味の悪さだけを持って飛信隊は内地へ帰還する。"},
  ...
  },
  {
    ...
    beats:[
      {ep:"13話", h:"斉王、来朝", body:"蔡沢の手引きにより、斉王・王建と趙の李牧が咸陽へ来朝する。合従軍で敵だった相手を同時に迎えるという、外交の見本市のような場面。"},
      {ep:"13〜14話", h:"法の話", body:"政は斉王との会談で、武ではなく『法』で国を治めると語る。それに感嘆した斉王は、事実上の降伏宣言を告げて帰る。一国が、戦わずに勝負を投げる。"},
      {ep:"14話", h:"七国同盟", body:"李牧との謁見では『七国同盟』が提案される。戦を止めるための連合という構想を、政は空論だと一蹴する。李牧は何も得ずに咸陽を去っていく。"},
      {ep:"1話（第6期）", h:"同じ理想、違う手段", body:"戦を無くすという目的は李牧と政で一致している。違うのは手段だけ——同盟で均衡を保つか、統一して戦の理由自体を消すか。以後の両者の戦いは、この一点の差から出ている。"},
      {ep:"1〜2話（第6期）", h:"飛信隊、募兵", body:"黒羊で何も得られなかった飛信隊は募兵を行い、新兵千人を増員する。隊の規模が上がるほど、突撃だけでは回らない現実が近づく。"},
      {ep:"2話（第6期）", h:"統一後の設計", body:"昌文君は統一後の法を作るために李斯を招き入れる。取った土地をどう回すかという問いが、戦の途中で先に設計され始める。"},
      {ep:"2話（第6期）", h:"鄴を狙う", body:"そして昌平君が奇策を献言する——趙王都・邯鄲の喉元にある大都市・鄴を取る。城ひとつではなく地方まるごとを削ぎ取るという、規模が一段変わった構想。"},
  ...
  },
  {
    ...
    beats:[
      {ep:"46巻", h:"連合軍、出陣", body:"始皇十一年、鄴攻略の策が完成する。総大将は王翦、楊端和と桓騎を各軍の大将に据えた二十万超の連合軍が出陣する。三人とも毛色の違う将であり、指揮系統が成立するかどうか自体が賭けだった。"},
      {ep:"46巻", h:"燕軍と司馬尚", body:"同時期、オルド率いる燕軍が趙へ侵攻し、青歌城主・司馬尚と激突する。だが別動隊が燕の城を落としたため燕軍は撤退。趙にまだ底が見えていない将がいることが示される。"},
      {ep:"46〜47巻", h:"列尾へ", body:"秦軍は趙の国門・列尾へ進軍する。李牧は秦の狙いが列尾ではなく鄴だと気づき、邯鄲へ急ぐ。狙いを読まれた時点で、この作戦は最初の設計を失っている。"},
      {ep:"47巻", h:"半日で落ちる城", body:"飛信隊と山の民が列尾を半日で陥落させる。だが王翦は、列尾が意図的に弱くしてあることに気づき、戦略の破綻を悟る。落ちすぎる城は罠である。"},
      {ep:"47〜48巻", h:"王翦の再設計", body:"王翦は密かに鄴を視察し、策を組み替える。列尾を放棄して全軍で攻め込み、鄴を兵糧責めにする。退路を捨てる代わりに、時間を武器に変える設計だった。"},
      {ep:"48巻", h:"三つの戦場", body:"連合軍は三方向に分かれる。楊端和軍が橑陽軍を迎撃し、鄴手前の九城を落として難民で溢れた鄴を桓騎軍が包囲、王翦軍は李牧率いる閼与軍と朱海平原で激突する。"},
      {ep:"48〜49巻", h:"朱海一日目・麻鉱の死", body:"蒙恬が趙右軍・紀彗軍を翻弄し、そこへ麻鉱軍が猛攻を掛ける。だが李牧自らが麻鉱を討ち、麻鉱軍は崩壊寸前に陥る。総大将が前線に出て将を刈るという、李牧の別の顔。"},
      {ep:"49巻", h:"蒙恬、臨時将軍", body:"蒙恬は崩れかけた麻鉱軍を立て直す。その夜、蒙恬は臨時将軍に昇格し、秦左軍の将となる。同世代で最初に軍を預かったのは蒙恬だった。"},
      {ep:"49〜50巻", h:"朱海二日目・玉鳳隊", body:"秦右軍の玉鳳隊は、元藺相如十傑・趙峩龍と岳嬰の挟撃を受ける。だが王賁は李牧副官・馬南慈軍へ突撃し、亜光軍との挟撃で大打撃を与える。"},
      {ep:"50〜51巻", h:"朱海三日目・尭雲", body:"秦右軍へ合流した飛信隊は藺家十傑・尭雲と対峙し、互角以上の戦いを繰り広げる。趙の旧世代最強格が、飛信隊の実力を測る基準になる。"},
      ...
      {ep:"49〜50巻", h:"橑陽・舜水樹の到着", body:"一方の楊端和軍は橑陽軍を圧倒していたが、李牧副官・舜水樹が到着すると趙軍は橑陽城まで整然と撤退する。個の武で押していた戦場に、策を持つ相手が来る。"},
      {ep:"50〜51巻", h:"橑陽・犬戎族", body:"橑陽城主・ロゾ率いる犬戎族が加勢し、戦局は膠着する。山の民にとって、同じ異民族との真正面からの潰し合いになる。"},
      {ep:"51〜52巻", h:"橑陽・兵糧焼失", body:"二日目の夜、援軍に赴いた壁が預かっていた兵糧が焼かれる。楊端和軍は勝ち筋ではなく期限と戦うことになる。"},
      {ep:"52〜53巻", h:"橑陽八日目の宣言", body:"兵糧が尽きかけた八日目の夜、楊端和は明日でロゾの息子——犬戎三兄弟を討つと宣言する。追い詰められた側が期限を自分で切る。"},
      {ep:"53巻", h:"橑陽九日目・落城", body:"三軍主攻の総攻撃で三兄弟を討つが、敵の反撃で軍は散り散りになる。楊端和は執拗に狙われるが、その隙に別働隊が橑陽城を陥落させ、最終的にロゾを壁が討ち取る。"},
      {ep:"53巻", h:"橑陽・接収と転進", body:"残存の犬戎族を従属させた楊端和は橑陽城を接収する。敗れた舜水樹ら趙軍は、秦軍の退路を断つべく列尾へ転進する。勝っても盤面は楽にならない。"},
